"""
LangGraph-based text-to-SQL agent for the Chinook database using Claude.
"""
...
class SQLAgent:
    """A text-to-SQL agent using LangGraph and Claude."""
    
    def __init__(self, api_key: str, model: str = "claude-3-sonnet-20240229"):
        """Initialize the SQL agent."""
        self.llm = ChatAnthropic(api_key=api_key, model=model, temperature=0)
